...
class mostel_output():
    ...
    def main(self):
        ...
        input_dir = f'static/uploads/{self.video_name}/edit/remove_edit/input/i_s'
        save_dir = f'static/uploads/{self.video_name}/edit/remove_edit/output'
        f = web_predict.style_transfer(config = config, input_dir = input_dir, save_dir = save_dir, 
                        checkpoint = checkpoint, vis = True, dilate = True)
        ...
        output_path = f'static/uploads/{self.video_name}/edit/remove_edit/output/0000_o_b.png'
        # i_s image path 가져오기
        i_s_path = f'static/uploads/{self.video_name}/edit/remove_edit/input/i_s/0000.png'
